...
class Listnew extends StatelessWidget{
  ...
  var list3=[Image(image: NetworkImage('https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8cGhvbmV8ZW58MHx8MHx8&auto=format&fit=crop&w=700&q=60'),height: 200,width: 200,),Image(image: NetworkImage('https://images.unsplash.com/photo-1565849904461-04a58ad377e0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cGhvbmV8ZW58MHx8MHx8&auto=format&fit=crop&w=700&q=60')),
  Image(image: NetworkImage('https://images.unsplash.com/photo-1565849904461-04a58ad377e0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cGhvbmV8ZW58MHx8MHx8&auto=format&fit=crop&w=700&q=60'),height: 200,width: 200,)];
    ...
    body: ListView.separated(itemCount: list1.length,
      itemBuilder: (BuildContext,index){
        return Card(child:
          ...
          title:
             Text(list1[index],textAlign: TextAlign.center,),
